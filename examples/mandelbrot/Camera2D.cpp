...
mat4wrap Camera2D::getInverseMatViewCL()
{
	glm::mat4 invMatView = glm::inverse(matView);
	return {
		invMatView[0][0], invMatView[1][0], invMatView[2][0], invMatView[3][0],
		invMatView[0][1], invMatView[1][1], invMatView[2][1], invMatView[3][1],
		invMatView[0][2], invMatView[1][2], invMatView[2][2], invMatView[3][2],
		invMatView[0][3], invMatView[1][3], invMatView[2][3], invMatView[3][3]
	};
}
